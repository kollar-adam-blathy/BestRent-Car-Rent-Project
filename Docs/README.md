...
![Adatbázis modell](Images/database/Database-model.png)
...
![Installer 1](Images/installer/1.png)
![Installer 2](Images/installer/2.png)
![Installer 3](Images/installer/3.png)
![Installer 4](Images/installer/4.png)
...
![Kezdőoldal](Images/web/web-home.png)
![Autólista](Images/web/web-cars.png)
![Autó részletek](Images/web/web-car-details.png)
![Bejelentkezés](Images/web/web-login.png)
![Regisztráció](Images/web/web-register.png)
![Ügyfél dashboard](Images/web/web-client-dashboard.png)
![Ügyfél profil](Images/web/web-client-profile.png)
![Foglalás oldal](Images/web/web-client-reserve-price.png)
![Admin dashboard](Images/web/web-admin-dashboard.png)
![Admin autó létrehozás](Images/web/web-admin-car-create.png)
![Admin foglalások](Images/web/web-admin-reservations.png)
![Admin fizetések](Images/web/web-admin-payments.png)

### Mobil felület

![Autók oldal](Images/mobile/Mobile-Cars.png)
![Bérlések oldal](Images/mobile/Mobile-Reservations.png)
